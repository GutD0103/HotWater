...
clean-Core-2f-Src-2f-DEVICE:
	-$(RM) ./Core/Src/DEVICE/flow_meter.cyclo ./Core/Src/DEVICE/flow_meter.d ./Core/Src/DEVICE/flow_meter.o ./Core/Src/DEVICE/flow_meter.su ./Core/Src/DEVICE/hotwater.cyclo ./Core/Src/DEVICE/hotwater.d ./Core/Src/DEVICE/hotwater.o ./Core/Src/DEVICE/hotwater.su ./Core/Src/DEVICE/ntc.cyclo ./Core/Src/DEVICE/ntc.d ./Core/Src/DEVICE/ntc.o ./Core/Src/DEVICE/ntc.su ./Core/Src/DEVICE/water_level.cyclo ./Core/Src/DEVICE/water_level.d ./Core/Src/DEVICE/water_level.o ./Core/Src/DEVICE/water_level.su
